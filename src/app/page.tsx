...
export default function Home() {
  return (
    <main className="flex items-center text-dark w-screen py-12 bg-[#151515]">
      <div className="flex flex-col-reverse md:flex-row items-center justify-between w-full px-4 sm:px-8 md:px-24 lg:px-64">
