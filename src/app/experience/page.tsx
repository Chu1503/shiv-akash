...
export default function Experience() {
  return (
    <>
      <main className="relative flex items-center justify-center w-full py-3 md:py-10 xl:py-16 bg-black overflow-hidden gap-20 lg:gap-10 xl:gap-20 flex-col lg:flex-row">
